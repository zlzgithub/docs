# Grafana模板 - MySQL Replication



![1589527889845](grafana-tmpl_mysql-repl/1589527889845.png)
  ...
  "templating": {
    "list": [
      ...
      },
      {
        ...
        "datasource": "Prometheus-PMM",
        "definition": "label_values(mysql_slave_status_seconds_behind_master, instance)",
        "hide": 0,
        "includeAll": false,
        "label": "Host",
        "multi": false,
        ...
        "name": "host",
        "options": [],
        "query": "label_values(mysql_slave_status_seconds_behind_master, instance)",
        "refresh": 1,
