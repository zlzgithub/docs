# Grafana模板 - Kubernetes cluster



![1589530237713](grafana-tmpl_k8s/1589530237713.png)
...
```json
{
  ...
  "panels": [
    ...
    },
    {
      ...
      "dashLength": 10,
      "dashes": false,
      "datasource": "Prometheus-K8s-Production",
      "decimals": 2,
      "editable": true,
      "error": false,
      "fill": 1,
  ...
  "timezone": "browser",
  "title": "Kubernetes cluster (Production)"
}
```
